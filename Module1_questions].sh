...
1. Which layer of the hierarchical LAN design model defines the summarization boundary for 
    the network control plane protocols and serves as the policy boundary?
...
4. Which hardware redundancy mechanism supports redundancy in a switch by allowing a redundant
