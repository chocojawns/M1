echo "            
  ...
  1.0 Architecture 15%
    ...
    1.1 Explain the different design principles used in an enterprise 
      network
    1.1.a Enterprise network design such as Tier 2, Tier 3, and Fabric
    Capacity planning
...
3.2 Layer 3
    ...
    vs. linked state, load balancing, path selection, path operations, metrics)
...
4.1 Diagnose network problems using tools such as debugs, conditional debugs,
